...
export class StudentService {
    ...
    async findById(id: number): Promise<StudentEntity> {
        ...
        if (!student) {
            throw new NotFoundException({ message: 'No existe el estudiante' });
        }
        return student;
    }
    ...
    async create(dto: StudentDto): Promise<any> {
        ...
        return { message: `Estudiante ${student.first_name} ${student.last_name} creado` };
    }
    ...
    async deleteById(id: number): Promise<any> {
        ...
        return { message: `Estudiante ${student.first_name} ${student.last_name} eliminado` };
    }
}
